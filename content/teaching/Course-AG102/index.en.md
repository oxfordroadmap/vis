...
weight: 2102
has_mermaid: true
title: ⁃AG102 🤗 Agentic Web Development
date: 2025-06-30
type: docs
params:
  emoji: 🤗
  id: AG102
  course: Agentic Web Development
  slug: Web_Dev-Agentic
tags:
  - AIE_course
  - Github
  - WebDevelopment
...
a.k.a. Web Development for AI Agents
...
### ![Web Development with Github and Hugging Face](content/teaching/Course-AG101/Web_Development_Github_HF.webp)


### Definitions
* 'Web Development' refers to the [the process of designing, building, and maintaining web applications](https://www.geeksforgeeks.org/web-tech/web-development/) It consists of `Frontend Development`, `Backend Development`, and `Full Stack Development` because of what the Web Standards (e.g. HTTP protocol) governs interactions between clients (e.g. browsers, mobile apps) and servers.
...
{{< details summary="details" title="💼🧾 Personal Portfolio Project Template" name="Final Project1" class="bg-primary-500/25" >}}
...
{{< details summary="details" title="🤖🧾 Personal AI PRD Project Template" name="Final Project2" class="bg-primary-500/25" >}}
...
![Github Edu](content/teaching/Course-AG101/Github_Edu.webp)
