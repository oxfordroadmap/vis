...
weight: 2102
has_mermaid: true
title: ⁃AG102 🤗 Agentic Web开发
date: 2025-06-30
type: docs
params:
  emoji: 🤗
  id: AG102
  course: Agentic Web开发
...
本系列课程 【🤖📲 _面向 LLM 驱动应用的网页开发_ 】（以下简称 ***本系列*** ）面向具有不同学科背景的入门级本科生，在 **大型语言模型 (LLM)** 的背景下，为现代网页开发的理论和实践方面提供全面的基础。
...
***本系列*** 为 **两学期**课程 （每学期 12-18 周，具体取决于院校安排），结构如下：
