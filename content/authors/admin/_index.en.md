...
work:
  - position: CEO, Data Scientist
    ...
    date_end: ''
    summary: |2-
      * Developed visualization apps and toolkits (e.g., NetBib, visCEADs, and visNetZero) for data-driven decisions in fields such as scientific research impact, industrial economics, and Net Zero transitions.
      * Delivered three SCIE-indexed Q2 peer-reviewed articles for the *Roadmapping for Precision-Decarbonization* research project ahead of its first expert-panel review.
...
awards:
  - title: _Certificate of Merit_
    ...
    summary: |
      TBA.
  - title: 'Province-Level “First Class”'
    url: https://www.edx.org/professional-certificate/uc-berkeleyx-blockchain-fundamentals
    date: '2023-07-01'
    awarder: Guangdong Department of Education
    icon: edx
    summary: |
      Delivered:
      - Guangdong Department of Education for the Capstone Project Course
  - title: 'Nation-Level First Prize'
  ...
  - title: 'Taiwan Merit Scholarships'
    ...
    summary: |
      Digital Content.
---
## About Me - [关于]({{% ref path="/experience" lang="zh" %}}) - [關於]({{% ref path="/experience" lang="zh-hant" %}}) 我
{class="text-3xl"}
